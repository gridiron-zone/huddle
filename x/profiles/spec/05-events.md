...
| message      | action                | huddle.profiles.v2.MsgSaveProfile |
...
| message        | module            | profiles                            | 
| message        | action            | huddle.profiles.v2.MsgDeleteProfile |
| message        | sender            | {userAddress}                       |
...
| message                      | module            | profiles                                  | 
| message                      | action            | huddle.profiles.v2.MsgRequestDTagTransfer |
...
| message                      | module            | profiles                                        | 
| message                      | action            | huddle.profiles.v2.MsgCancelDTagTransferRequest |
| message                      | sender            | {userAddress}                                   |
...
| message                      | module            | profiles                                        | 
| message                      | action            | huddle.profiles.v2.MsgAcceptDTagTransferRequest |
| message                      | sender            | {userAddress}                                   |
...
| message                      | module            | profiles                                        | 
| message                      | action            | huddle.profiles.v2.MsgRefuseDTagTransferRequest |
| message                      | sender            | {userAddress}                                   |
...
| message            | module                       | profiles                               | 
| message            | action                       | huddle.profiles.v2.MsgLinkChainAccount |
| message            | sender                       | {userAddress}                          |
...
| message              | module                       | profiles                                 | 
| message              | action                       | huddle.profiles.v2.MsgUnlinkChainAccount |
| message              | sender                       | {userAddress}                            |
...
| message                      | module                      | profiles                                | 
| message                      | action                      | huddle.profiles.v3.MsgSetDefaultAddress |
| message                      | sender                      | {userAddress}                           |
...
| message          | module                         | profiles                              | 
| message          | action                         | huddle.profiles.v2.MsgLinkApplication |
| message          | sender                         | {userAddress}                         |
...
| message            | module               | profiles                                | 
| message            | action               | huddle.profiles.v2.MsgUnlinkApplication |
| message            | sender               | {userAddress}                           |
