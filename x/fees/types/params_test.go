...
func TestValidateParams(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			params: types.NewParams([]types.MinFee{
				types.NewMinFee("/huddle.profiles.v2.SaveProfile", sdk.Coins{sdk.Coin{Denom: "", Amount: sdk.NewInt(1)}}),
			}),
			shouldErr: true,
		},
		{
			...
			params: types.NewParams([]types.MinFee{
				types.NewMinFee("/huddle.profiles.v2.SaveProfile", sdk.NewCoins(sdk.NewCoin("stake", sdk.NewInt(1)))),
				types.NewMinFee("/huddle.profiles.v2.SaveProfile", sdk.NewCoins(sdk.NewCoin("photino", sdk.NewInt(1)))),
			}),
			shouldErr: true,
		},
		{
		...
		},
		{
			...
			params: types.NewParams([]types.MinFee{
				types.NewMinFee("/huddle.profiles.v2.SaveProfile", sdk.NewCoins(sdk.NewCoin("stake", sdk.NewInt(1)))),
				types.NewMinFee("/huddle.profiles.v2.CreateChainLink", sdk.NewCoins(sdk.NewCoin("photino", sdk.NewInt(1)))),
			}),
			shouldErr: false,
		},
	}
