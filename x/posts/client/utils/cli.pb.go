...
// source: huddle/posts/v2/client/cli.proto
...
import (
	...
	types "github.com/gridiron-zone/huddle/x/posts/types"
...
type CreatePostJSON struct {
	...
	ReplySettings types.ReplySetting `protobuf:"varint,7,opt,name=reply_settings,json=replySettings,proto3,enum=huddle.posts.v2.ReplySetting" json:"reply_settings,omitempty"`
...
func (*CreatePostJSON) Descriptor() ([]byte, []int) {
	return fileDescriptor_580e9e6caba58b72, []int{0}
}
...
func (*EditPostJSON) Descriptor() ([]byte, []int) {
	return fileDescriptor_580e9e6caba58b72, []int{1}
}
...
func init() {
	proto.RegisterType((*CreatePostJSON)(nil), "huddle.posts.v2.client.CreatePostJSON")
	proto.RegisterType((*EditPostJSON)(nil), "huddle.posts.v2.client.EditPostJSON")
}

func init() { proto.RegisterFile("huddle/posts/v2/client/cli.proto", fileDescriptor_580e9e6caba58b72) }

var fileDescriptor_580e9e6caba58b72 = []byte{
	// 477 bytes of a gzipped FileDescriptorProto
	,
}
