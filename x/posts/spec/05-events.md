...
| message     | action            | huddle.posts.v2.MsgCreatePost |
...
| message   | module            | posts                       |
| message   | action            | huddle.posts.v2.MsgEditPost |
| message   | sender            | {userAddress}               |
...
| message     | module            | posts                         |
| message     | action            | huddle.posts.v2.MsgDeletePost |
| message     | sender            | {userAddress}                 |
...
| message             | module            | posts                                |
| message             | action            | huddle.posts.v2.MsgAddPostAttachment |
| message             | sender            | {userAddress}                        |
...
| message                | module            | posts                                   |
| message                | action            | huddle.posts.v2.MsgRemovePostAttachment |
| message                | sender            | {userAddress}                           |    
...
| message     | module            | posts                         |
| message     | action            | huddle.posts.v2.MsgAnswerPoll |
| message     | sender            | {userAddress}                 |
