...
```js reference
https://github.com/gridiron-zone/huddle/blob/master/proto/huddle/reactions/v1/msgs.proto#L38-L60
```
...
```js reference
https://github.com/gridiron-zone/huddle/blob/master/proto/huddle/reactions/v1/msgs.proto#L71-L94
```
...
```js reference
https://github.com/gridiron-zone/huddle/blob/master/proto/huddle/reactions/v1/msgs.proto#L99-L117
```
...
```js reference
https://github.com/gridiron-zone/huddle/blob/master/proto/huddle/reactions/v1/msgs.proto#L129-L153
```
...
```js reference
https://github.com/gridiron-zone/huddle/blob/master/proto/huddle/reactions/v1/msgs.proto#L159-L176
```
...
```js reference
https://github.com/gridiron-zone/huddle/blob/master/proto/huddle/reactions/v1/msgs.proto#L182-L205
```
