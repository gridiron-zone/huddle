...
title: Use RocksDB
sidebar_label: Use RocksDB
slug: rocksdb-installation
---
...
# Installing RocksDB
By default, Huddle uses [LevelDB](https://github.com/google/leveldb) as its database backend engine. However, since version 
...
[RocksDB installation guide](06-rocksdb-installation.mdx) before proceeding further.

The following guide allows you to install [Facebook's RocksDB](https://github.com/facebook/rocksdb) inside your local machine,
so that you will be able to use as Huddle' backend engine for better performances.
...
# Install RocksDB so that Huddle can access it
...
Once the installation has finished, you will be able to compile Huddle using the following command: 
