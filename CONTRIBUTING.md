...
Subsequently after the meeting, and pending final approval from the DF,
...
* Missing 3 scheduled meetings results in DF evaluating whether the member should be
  removed / replaced
...
*Note: For any major or minor release series denoted as a "Stable Release" (e.g. v1.0.0), a separate release
