...
import (
	...
	"github.com/gridiron-zone/huddle/app/huddle/cmd/chainlink/types"
...
func (suite *CreateJSONChainLinkTestSuite) SetupSuite() {
	...
	suite.Owner = "huddle1n8345tvzkg3jumkm859r2qz0v6xsc3henzddcj"
}
...
func (mock MockGetter) GetOwner() (string, error) {
	return "huddle1n8345tvzkg3jumkm859r2qz0v6xsc3henzddcj", nil
}
