...
import (
	...
	"github.com/gridiron-zone/huddle/app/huddle/cmd/chainlink"
	"github.com/gridiron-zone/huddle/app/huddle/cmd/sign"
	...
	chainlinktypes "github.com/gridiron-zone/huddle/app/huddle/cmd/chainlink/getter"
	chainlinkprovider "github.com/gridiron-zone/huddle/app/huddle/cmd/chainlink/provider"
	genutilcli "github.com/gridiron-zone/huddle/x/genutil/client/cli"
)

// NewRootCmd creates a new root command for huddle. It is called once in the
// main function.
...
func initAppConfig() (string, interface{}) {
	...
	//
	// In Huddle, we set the min gas prices to 0.
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig params.EncodingConfig) {
	...
	server.AddCommands(rootCmd, app.DefaultNodeHome, newApp, createHuddleappAndExport, addModuleInitFlags)
...
// createHuddleappAndExport creates a new app (optionally at a given height)
// and exports state.
func createHuddleappAndExport(
	...
	var huddleApp *app.HuddleApp
	if height != -1 {
		huddleApp = app.NewHuddleApp(
		...
		err := huddleApp.LoadHeight(height)
		if err != nil {
	...
	return huddleApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
